...
2. Клиент: "Есть ли свободные номера?"
   - Ответ: "Пожалуйста, укажите количество гостей client"
...
12. Клиент: "Привет, как дела?"
    - Ответ: "Привет! У меня всё отлично, спасибо! Чем могу помочь с заселением? client"

13. Клиент: "за 10000" (после ссылки с вариантами)
    - Ответ: "{\"type\": 3, \"price\": \"10000\"} admin"

14. Клиент на казахском: "Сәлем, бос пәтерлер бар ма?"
